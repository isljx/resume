...
function controlpage($obj,self_h){
...
function mouseOnOut($obj){ 
	var liObj = $obj.children("ul").children("li");
	$(liObj).each(function() {
        $(this).mouseover(function(e) {
            console.log("前提");
		$(this).addClass("selected").siblings().removeClass("selected");
		$(this).find(".scale-box .top").stop(true);
	    $(".scale-left-main li.selected").children(".scale-box").addClass("selected").children(".top").slideUp("fast");
		console.log("移入");
        });
		$(this).mouseout(function(e) {
            ...
            $(this).children(".scale-box").removeClass("selected").children(".top").slideDown("fast");
			console.log("移出");
			}
